...
!(function (t, e) {
  ...
  g(document)
    ...
    g(window).on(j.LOAD_DATA_API, function () {
      ...
      for (let r = 0, s = (t = [].slice.call(document.querySelectorAll(N))).length; r < s; r++) {
        const a = t[r];
      ...
      return (
        ...
        (t._slide = function (t, e) {
          ...
          if (((o = t === K ? ((n = J), (i = Z), B) : ((n = G), (i = tt), V)), l && g(l).hasClass(X)))
            ...
            const u = g.Event(Y.SLID, { relatedTarget: l, direction: o, from: a, to: c });
  ...
  g(document).on(Y.CLICK_DATA_API, lt, ut._dataApiClickHandler),
    g(window).on(Y.LOAD_DATA_API, function () {
      for (let t = [].slice.call(document.querySelectorAll(ct)), e = 0, n = t.length; e < n; e++) {
        const i = g(t[e]);
  ...
  const ft = "collapse",
    ...
    wt = (function () {
      function a(e, t) {
        ...
        for (let n = [].slice.call(document.querySelectorAll(It)), i = 0, o = n.length; i < o; i++) {
          const r = n[i],
      ...
      return (
              ...
              if (0 < i)
                for (let o = 0; o < i; o++) {
                  const r = this._triggerArray[o],
                    s = _.getSelectorFromElement(r);
                  if (null !== s)
                    g([].slice.call(document.querySelectorAll(s))).hasClass(Et) ||
        ...
        (a._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              (!e && n.toggle && "string" == typeof i && /show|hide/.test(i) && (n.toggle = !1),
      ...
      return (
        ...
        (c._clearMenus = function (t) {
          if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
            for (let e = [].slice.call(document.querySelectorAll(Mt)), n = 0, i = e.length; n < i; n++) {
          ...
          if (
            ...
            if (n || 27 !== t.which)
              if (n && (!n || (27 !== t.which && 32 !== t.which))) {
                const i = [].slice.call(e.querySelectorAll(Vt)).filter(function (t) {
      ...
      return (
        ...
        (t._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            const t = [].slice.call(document.querySelectorAll(ye)),
  ...
  const be = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"],
    Se = {
        ...
        (t._setListeners = function () {
          ...
          this.config.trigger.split(" ").forEach(function (t) {
            if ("click" === t)
              ...
              const e = t === Be ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
  ...
  g(window).on(pn.LOAD_DATA_API, function () {
    for (let t = [].slice.call(document.querySelectorAll(yn)), e = t.length; e--; ) {
      const n = g(t[e]);
      ...
      return (
        (t.show = function () {
          ...
          if (
            ...
            if (e) {
              const r = "UL" === e.nodeName || "OL" === e.nodeName ? Kn : Mn;
