 ...
 */ (function (e, t) {
  ...
  function u(e) {
    ...
    let p = { left: o.left, top: o.top, width: o.right - o.left, height: o.bottom - o.top },
  ...
  function b(e, o) {
    const i = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
      p = r(10),
      s = "HTML" === o.nodeName,
      d = u(e),
      a = u(o),
    ...
    let b = g({ top: d.top - a.top - h, left: d.left - a.left - c, width: d.width, height: d.height });
  ...
  function v(e, t, i, r) {
    let p = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
      s = { top: 0, left: 0 },
      d = p ? E(e) : a(e, t);
  ...
  function L(e, t, o) {
    const n = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null,
      i = n ? E(t) : a(t, o);
    return b(o, i, n);
  }
  function S(e) {
  ...
  function H(e) {
    for (
      let t = [!1, "ms", "Webkit", "Moz", "O"], o = e.charAt(0).toUpperCase() + e.slice(1), n = 0;
      n < t.length;
      n++
    ) {
      const i = t[n],
    ...
    fe =
      ...
      function (e) {
        for (var t, o = 1; o < arguments.length; o++)
          for (const n in ((t = arguments[o]), t)) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
        return e;
      },
      ...
      modifiers: {
        ...
        preventOverflow: {
          ...
          fn: function (e, t) {
            ...
            const n = H("transform"),
              ...
              d = i[n];
            (i.top = ""), (i.left = ""), (i[n] = "");
            const a = v(e.instance.popper, e.instance.reference, t.padding, o, e.positionFixed);
        ...
        flip: {
          ...
          fn: function (e, t) {
            ...
            let o = v(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
